...
/*
 $Log: dio.h,v $
 Revision 1.4  2006/02/07 16:39:18  barnes
 Fixed types for DIOSetPhase.

 Revision 1.3  2005/06/16 16:35:52  barnes
 Modification to the set phase syntax.

 Revision 1.2  2004/11/15 14:46:40  barnes
 Added routine to set phase.
...
int DIOSetPhase(ipcid_t ipcid,unsigned char phase,unsigned char bmnum);

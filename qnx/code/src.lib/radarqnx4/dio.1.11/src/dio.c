...
/*
 $Log: dio.c,v $
 Revision 1.11  2006/02/07 21:46:55  barnes
 Added missing header.

 Revision 1.10  2006/02/07 16:36:01  barnes
 Modified the send TSG routine to report the error number.
 (Dieter Andre's modification).

 Revision 1.9  2005/06/16 16:36:06  barnes
 Modification to the set phase syntax.

 Revision 1.8  2004/11/15 14:45:32  barnes
 Added routine for setting phase.
...
int DIOSetPhase(ipcid_t ipcid,unsigned char phase,unsigned char beam) {

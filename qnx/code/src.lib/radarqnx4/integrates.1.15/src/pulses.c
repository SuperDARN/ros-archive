...
/*
 $Log: pulses.c,v $
 Revision 1.2  2007/08/07 16:10:12  code
 Fixed bug in doing the A/D scan on the second channel.
...
int IntegrateSPulse(int buffer,
  ...
  if (ADDoScan(adid[1],buffer,2*sampleB*channelB,0,2*channelB) !=0) return -1;

...
/*
 $Log: char.c,v $
 Revision 1.4  2004/08/27 23:04:42  barnes
 Fixed bug in allocating huge arrays for rendering empty characters.

 Revision 1.3  2004/06/16 16:23:14  barnes
 Added missing header.

 Revision 1.2  2004/04/26 19:48:22  barnes
 Audit - Enforced warning set to "all".

 Revision 1.1  2003/03/14 18:23:28  barnes
 Initial revision

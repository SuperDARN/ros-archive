...
/*
 $Log: freq_lib.c,v $
 Revision 1.6  2001/06/27 20:53:28  barnes
 Added license tag

 Revision 1.5  2001/01/29 18:11:50  barnes
 Added Author Name

 Revision 1.4  2001/01/29 16:28:22  barnes
 Added missing RCS log.
...
struct freq_table *load_ftable(FILE *fp) {
  ...
  int i,j;
  int s,e,status;
  struct freq_table *ptr;
  ptr=malloc(sizeof(struct freq_table));

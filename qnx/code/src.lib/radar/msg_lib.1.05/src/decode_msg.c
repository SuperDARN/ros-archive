...
/*
 $Log: decode_msg.c,v $
 Revision 1.5  2001/12/17 16:16:41  barnes
 Modification to make sure freed memory blocks are marked with NULL
 pointers.

 Revision 1.4  2001/06/27 20:53:53  barnes
 Added license tag

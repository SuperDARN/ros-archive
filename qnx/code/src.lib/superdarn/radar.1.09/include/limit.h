...
/*
 $Log: limit.h,v $
 Revision 1.10  2008/03/17 21:32:20  code
 Changed limit of IQBUFSIZE.

 Revision 1.9  2008/03/14 18:05:00  code
 Added IQBUFSIZE

 Revision 1.8  2008/03/13 15:15:57  code
 Added MAXNAVE for maximum number of pulse sequences.

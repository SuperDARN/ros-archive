...
/*
 ...
 Revision 1.5  2007/02/02 21:40:15  code
 Changed cross-range interference threshold (pwr_ratio) from 0.3*nave to 1 (line
  122 from version 1.4)
  and commented out declaration of MIN_PWR_RATIO = .3

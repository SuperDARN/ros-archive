...
/*
 $Log: fit_scan.c,v $
 Revision 1.20  2002/02/07 21:19:36  barnes
 Removed possible screw ups in decoding the channel information.

 Revision 1.19  2002/02/06 17:44:04  barnes
 Simplified code for filtering channels.

 Revision 1.18  2002/02/06 15:45:12  barnes
 Added read routines that can filter based on channel ID.

 Revision 1.17  2002/02/01 18:34:31  barnes
 Added missing header.

 Revision 1.16  2001/06/27 20:48:04  barnes
 Added license tag

 Revision 1.15  2001/01/29 18:11:52  barnes
 Added Author Name

 Revision 1.14  2001/01/29 16:29:37  barnes
...
int fit_read_scan_channel(struct fitfp *fp,struct radardata *ptr,
  ...
  /* reads one scans worth of data from the current position 
   *  in the fit file testing for channel information.
   */
   int bmnum,cnt;
   int rng,i,j,c=0;
   int fstatus=0;

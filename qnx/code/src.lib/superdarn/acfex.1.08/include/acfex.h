...
/*
 $Log: acfex.h,v $
 Revision 1.3  2008/03/14 18:58:15  code
 Removed smpdelay - see note in C module.

 Revision 1.2  2007/02/19 15:30:00  code
 Added roffset and ioffset.

 Revision 1.1  2007/02/12 18:05:19  code
 Initial revision

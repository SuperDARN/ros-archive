...
char *hlpstr[]={
   ...
   "                 [-ed yyyymmdd] [-ex hr:mn] [-cn a|b]\n",
   "                 [-cp cpid] infitfile [ininxfile] \n",
   "                 outfitfile\n",
   ...
   "-cn a|b       include only data from channel A or channel B.\n",
   "-cp cpid      include only date with this program id.\n",

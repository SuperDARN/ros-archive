...
int initPCI9080(int pci_index,
                int *ad_irq,long *BASE1,long *BASE2,long *BASE3,
                long *PCICR){
  ...
  *BASE3=(long) pci_reg.Base_Address_Regs[2];
  ...
  temp_out=outpd(localbase+reg_PCI9080_BIGEND,0x00);
  temp_in=inpd(localbase+reg_PCI9080_BIGEND);
  temp_out=outpd(localbase+reg_PCI9080_CNTRL,write_PCI9080_CNTRL);
  temp_in=inpd(localbase+reg_PCI9080_CNTRL);
  temp_in=inpd(localbase+reg_PCI9080_INTCSR);
  temp_out=outpd(localbase+reg_PCI9080_INTCSR,temp_in | 0x00011100);  

...
/*
 $Log: main.h,v $
 Revision 1.3  2007/11/13 17:51:45  code
 Added flag for digital frequency synthesizers.

 Revision 1.2  2004/11/12 15:13:41  barnes
 Modifications to deal with digitally phased radars.

 Revision 1.1  2004/07/13 22:59:17  barnes
 Initial revision
...
struct dio_param {
  ...
  int freq[2]; 
  unsigned char antenna_mode[2];
  unsigned char antenna[2];
  unsigned char phase[2];
  unsigned char test_mode[2];
  int seq_no;
  int seq_id[2];
  int status;
  int fstatus[2];

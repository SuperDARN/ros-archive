...
/*
 $Log: gc214.c,v $
 Revision 1.5  2008/03/12 17:43:12  code
 Added the meteor echoes sampling.

 Revision 1.4  2008/03/12 14:17:47  code
 Blackstone code fixes from Todd.

 Revision 1.3  2007/11/13 16:01:59  code
 For now sample of channel C&D at same rate as A&B.

 Revision 1.2  2007/11/13 15:26:11  code
 Simplification of code to remove meteor code.
...
void setupGC214(long base_GC214,int cfg,int clkdly,int bcnt,
  ...
  write32(base_GC214+offset_GC214+reg_GC214_CFG,0x00000053);

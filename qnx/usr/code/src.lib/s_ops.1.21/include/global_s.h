...
extern float pwr0_A[MAX_RANGE];
extern float acfd_A[MAX_RANGE*LAG_TAB_LEN*2];
extern float xcfd_A[MAX_RANGE*LAG_TAB_LEN*2];

extern float pwr0_B[MAX_RANGE];
extern float acfd_B[MAX_RANGE*LAG_TAB_LEN*2];
extern float xcfd_B[MAX_RANGE*LAG_TAB_LEN*2];

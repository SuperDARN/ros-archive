...
/*
 $Log: base_fclr_s.c,v $
 Revision 1.4  2002/03/26 16:55:05  barnes
 Fixed redundant headers.

 Revision 1.3  2001/10/15 16:26:01  barnes
...
int base_fclr_s(int tsg_id,int samples,int debug,
   ...
   float lowest_pwrA[NUM_FCLR_FREQ];  /* corresponding power of lowest_freq */
   float lowest_pwrB[NUM_FCLR_FREQ];  /* corresponding power of lowest_freq */

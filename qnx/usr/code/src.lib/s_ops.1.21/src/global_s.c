...
/* 
 $Log: global_s.c,v $
 Revision 1.7  2002/03/26 16:55:05  barnes
 Fixed redundant headers.

 Revision 1.6  2002/03/26 16:49:11  barnes
 Fixed missing header.

 Revision 1.5  2001/10/15 16:26:01  barnes
...
float pwr0_A[MAX_RANGE];
float acfd_A[MAX_RANGE*LAG_TAB_LEN*2];
float xcfd_A[MAX_RANGE*LAG_TAB_LEN*2];

float pwr0_B[MAX_RANGE];
float acfd_B[MAX_RANGE*LAG_TAB_LEN*2];
float xcfd_B[MAX_RANGE*LAG_TAB_LEN*2];

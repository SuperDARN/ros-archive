...
/*
 $Log: tmseq.c,v $
 Revision 1.4  2008/03/19 21:50:12  code
 Reset the timing sequence parameters.

 Revision 1.3  2006/11/07 22:00:23  code
 Added start delay.

 Revision 1.2  2006/01/25 18:47:29  barnes
 Forced rtoxmin to be set correctly.

 Revision 1.1  2004/11/09 17:48:30  barnes
 Initial revision

...
/*
 $Log: tmseq.c,v $
 Revision 1.6  2008/03/21 18:10:33  code
 Brought inline with the Saskatoon installation.

 Revision 1.5  2008/03/21 16:27:45  code
 Added support for I&Q capture.

 Revision 1.4  2007/03/01 15:34:32  code
 Forced stdelay to zero to prevent an undefined number being passed.

 Revision 1.3  2006/08/17 20:26:39  code
 Added support for extended lag tables.

 Revision 1.2  2004/12/20 17:55:38  barnes
 Fixe bug in setting parameter block.

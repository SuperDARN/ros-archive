...
/*
 $Log: tmseq.c,v $
 Revision 1.6  2008/03/21 17:21:32  code
 Added I&Q capture.

 Revision 1.5  2007/08/07 18:43:55  code
 Removed some redundancy and forces the extra delay terms to be set to zero.

 Revision 1.4  2007/03/01 15:34:32  code
 Forced stdelay to zero to prevent an undefined number being passed.

 Revision 1.3  2006/08/17 20:24:09  code
 Added support for extended lag tables.

 Revision 1.2  2006/03/30 11:02:44  barnes

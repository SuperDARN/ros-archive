...
/*
 $Log: interface.c,v $
 Revision 1.3  2008/03/21 18:17:43  code
 Brought inline with the Prince George installation.

 Revision 1.2  2008/03/21 16:22:08  code
 Added support for I&Q capture.

 Revision 1.1  2004/07/22 21:08:31  barnes
 Initial revision
...
void SiteStart() {
  ...
  dfrq=14400;
  nfrq=10200;
  frqrng=300; /* changed from 500 to comply with different filters 20050805; DA */

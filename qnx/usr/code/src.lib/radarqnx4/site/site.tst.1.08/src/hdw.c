...
/*
 $Log: hdw.c,v $
 Revision 1.6  2008/03/21 16:55:10  code
 Added I&Q capture.

 Revision 1.5  2008/03/12 20:36:36  code
 Changed the clear frequency functions.

 Revision 1.4  2007/10/30 15:42:18  code
 Fixed bugs in stereo code.

 Revision 1.3  2007/10/29 17:22:48  code
 Stereo digital receiver code.

 Revision 1.2  2007/05/23 17:17:36  code
 Changes for the digital receiver.

 Revision 1.1  2007/05/22 16:48:46  code
 Initial revision
...
int SiteFCLR(int sfrq,int efrq) { 
  ...
  tfreq=FCLRGC214(dioid,drid[0],ftable,sfrq,efrq,rsep,40625000,REAL_BUF_OFFSET,
...
int SiteFCLRS(int sfrqA,int efrqA,int sfrqB,int efrqB) { 
  ...
  s=FCLRSGC214(dioid,drid,ftable,
         ...
         40625000,REAL_BUF_OFFSET,IMAG_BUF_OFFSET, 
         bufadr,bufoff,

...
/*
 $Log: hdw.c,v $
 Revision 1.9  2008/03/21 15:42:47  code
 Added support for I&Q sample capture.

 Revision 1.8  2007/02/08 16:21:44  code
 Added lagnum.

 Revision 1.7  2006/08/17 20:09:35  code
 Added (future) support for extended lag tables.

 Revision 1.6  2006/07/24 16:28:18  code
 Passed beam number and frequency to the integrate library.

 Revision 1.5  2006/06/14 13:42:05  code
 Corrected name of the A/D driver.

 Revision 1.4  2006/04/12 15:49:10  barnes
 Adopted rawfeed.

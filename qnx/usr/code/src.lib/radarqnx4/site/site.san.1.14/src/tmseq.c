...
/*
 $Log: tmseq.c,v $
 Revision 1.6  2008/03/19 21:25:23  code
 Fixed typo.

 Revision 1.5  2008/03/19 21:22:22  code
 Force timing sequence parameters to zero.

 Revision 1.4  2008/03/19 14:12:38  code
 Added support for I&Q sampling.

 Revision 1.3  2007/03/01 15:34:32  code
 Forced stdelay to zero to prevent an undefined number being passed.

 Revision 1.2  2006/08/17 20:25:41  code
...
int SiteTimeSeq(int *patn) {
  ...
  /* force the timing sequence to zero values */

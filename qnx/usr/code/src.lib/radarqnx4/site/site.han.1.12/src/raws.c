...
/*
 $Log: raws.c,v $
 Revision 1.3  2007/08/08 13:45:53  code
 Fixed problems with setting the structures.

 Revision 1.2  2007/08/07 20:35:36  code
 Fixed ACF table and added origin and beam offset.

 Revision 1.1  2006/03/30 11:09:59  barnes
 Initial revision

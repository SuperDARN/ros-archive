...
/*
 $Log: tmseq.c,v $
 Revision 1.5  2008/03/21 16:14:53  code
 ...
 Revision 1.3  2005/07/29 14:54:04  barnes
 Changed the delay after TC to 360.

 Revision 1.2  2004/12/20 17:54:57  barnes
 Fixed bug in parameter block.

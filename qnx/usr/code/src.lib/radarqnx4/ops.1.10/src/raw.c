...
/*
 $Log: raw.c,v $
 Revision 1.5  2007/07/03 19:33:19  code
 Added missing end lag.

 Revision 1.4  2006/08/18 14:29:41  code
 Modification to deal with extended lag tables.

 Revision 1.3  2006/07/11 21:13:38  code
 Added beam azimuth and origin code.

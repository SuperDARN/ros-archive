...
/*
 $Log: setup.c,v $
 Revision 1.6  2008/03/14 15:33:26  code
 Removed allocation of storage for I&Q samples - this now belongs in the site library.

 Revision 1.5  2008/03/13 20:56:18  code
 Added access to the raw I&Q samples.

 Revision 1.4  2007/07/09 18:21:40  code
 Keep the radar data structures alive.

 Revision 1.3  2006/07/11 21:13:38  code
 Added function OpsSetupCommand.

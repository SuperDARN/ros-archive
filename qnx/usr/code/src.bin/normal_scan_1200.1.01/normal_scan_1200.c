...
/*
 $Log: normal_scan_1200.c,v $
 Revision 1.1  2002/06/07 20:02:59  barnes
 Initial revision
...
char program_name[40]={"normal_scan_1200"};
char program_id[80]={"$Id: normal_scan_1200.c,v 1.1 2002/06/07 20:02:59 barnes Exp $"};
char command[1024];

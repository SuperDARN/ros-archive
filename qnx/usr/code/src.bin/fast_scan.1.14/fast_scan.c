...
/* 
 $Log: fast_scan.c,v $
 Revision 1.14  2001/02/14 14:55:01  barnes
 Changed CPID to 151.

 Revision 1.13  2000/12/14 15:44:47  barnes
 Fixed bug in command line options.

 Revision 1.12  2000/11/29 17:16:37  barnes
 Fixed possible buffer overflows with comment buffer.

 Revision 1.11  2000/11/20 16:27:14  barnes
 Added missing headers and added reporting of synthesizer status.

 Revision 1.10  2000/11/20 15:32:09  barnes
 Fixed numerous bugs.

 Revision 1.9  2000/11/14 22:12:55  barnes
 Fixed bug in the RCS keyword ID

 Revision 1.8  2000/11/14 22:12:00  barnes
 Modified the reporting of the program name.

 Revision 1.7  2000/11/14 22:09:40  barnes
 Fixed bug in reporting the program name.

 Revision 1.6  2000/11/14 21:41:53  barnes
 Modifications to improve error reporting.
...
char program_name[40]={"fast_scan"};
char program_id[80]={"$Id: fast_scan.c,v 1.14 2001/02/14 14:55:01 barnes Exp $"};
char command[1024];

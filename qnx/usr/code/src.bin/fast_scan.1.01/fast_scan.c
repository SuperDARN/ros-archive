...
/* 
 $Log: fast_scan.c,v $
 Revision 1.3  2000/04/17 21:38:40  barnes
 Moved task names to a header file.

 Revision 1.2  2000/03/15 14:05:17  barnes
 Fixed nasty bug that meant timing sequence was not being updated when parameters were changed.

 Revision 1.1  1999/09/17 21:40:45  barnes
 Initial revision
...
void main(int argc,char *argv[]) {
  ...
  /* set up the hardware, tables, and communication links */
  ...
  start_program(); /* call site specific program start */
 ...
 /* setup the timing sequence */
  ...
  /* append discretionary flag to the name */

  if (discretion) strcat(program_name,"(dt)");
